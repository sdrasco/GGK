function inspiral = KludgedInspiral_epiELQ(a, M, mu, t, e, p, iota_deg, E, L, Q, t0, tol)
%
...
for i=1:length(t)
    ...
    inspiral.geodesic{i} = KerrGeodesic_epiELQ(a, e(i), p(i), ...
                           iota_deg(i), E(i), L(i), Q(i), tol);
