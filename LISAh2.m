function [hI hII tt] = LISAh2(a, e0, p0, iota_deg0, r0, theta0_deg, phi0_deg, ... 
...
extra = 2000;
%extra = 0; % TEST (since Steve's code doesn't use this delay yet)
...
ttI = max(tI,min(t_shift));
ttF = min(tF,max(t_shift));
tt = linspace(ttI,ttF,SmallSteps);
