function waveform = OriginalInitializeWaveform(a, e0, p0, iota_deg0, ...
    t0, r0, theta0_deg, phi0_deg, sign_rdot0, sign_Tdot0, ...
    M, mu, tspan, SmallSteps, BigSteps, tol, coords)
% 
% waveform = InitializeWaveform(a, e0, p0, iota_deg0,t0, r0, theta0_deg,phi0_deg, sign_rdot0, sign_Tdot0, M, mu, tspan, SmallSteps, BigSteps,tol, coords);
%
...
%             theta_min = 90 - iota_deg0 for prograde orbits (iota < 90),
%             theta_min = iota_deg0 - 90 for retrograde orbits (iota > 90).
...
%             t: coordinate time in seconds from EVOLVEORBIT
%             e: eccentricity as a function of t from EVOLVEORBIT
%             p: semilatus rectum as a function of t from EVOLVEORBIT
...
%
% See also EVOLVEORBIT, KLUDGEDINSPIRAL, KLUDGEDXOFL OBSERVEWAVEFORM
% 
% By: Steve Drasco
% 
...
if iota_deg0 < 90
  theta_min = 90 - iota_deg0;
else
  theta_min = iota_deg0 - 90;
end
...
[t, p, e, iota_hughes_rad] = EvolveOrbit(p0,e0,waveform.iota_hughes_deg0*pi/180,...
