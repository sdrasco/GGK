function inspiral = phase_KludgedInspiral(a, M, mu, t, e, p, iota_deg, phase0, tol)
%
% inspiral = KludgedInspiral(a, M, mu, t, e, p, iota_deg, phase0, tol)
%
...
t0 = -inspiral.geodesic{1}.Gamma * phase0(1);
for n=1:inspiral.geodesic{1}.nmax
    t0 = t0 - inspiral.geodesic{1}.tn(n) ...
        * sin(n * inspiral.geodesic{1}.UpsilonR * phase0(2));
end
for k=1:inspiral.geodesic{1}.kmax
    t0 = t0 - inspiral.geodesic{1}.tk(k) ...
        * sin(k * inspiral.geodesic{1}.UpsilonTheta * phase0(3));
end
ooG = 1./Gamma;
...
% this will have taken a while - save the output structure
%save('KludgedInspiralData.mat','inspiral');
%display('Saved output structure to: KludgedInspiralData.mat');
